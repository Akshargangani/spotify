        ...
        <div className='body'>
            ...
            <div className="main-content">
                ...
                <div className="playlist">
                    ...
                    <div>
                        <img alt="K/DA" height="50" src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/10.spotify-clone/assets/image3.png?raw=true" width="50" />
                        <p>K/DA</p>
                    </div>
                    <div>
            ...
            <div className="footer">
                <div>
                    ...
                    <div className="image-2">
                        <img style={{ width: '30vw', height: '45px' }} src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/10.spotify-clone/assets/Music%20Player%20Options.png?raw=true" alt="Music Player Options" />
                    </div>
                    <div className="image-3">
                        <img style={{ width: '15vw', height: '3vh' }} src="https://github.com/PatelNeelMahesh/frontend_tasks/blob/main/10.spotify-clone/assets/Right%20options.png?raw=true" alt="Right options" />
                    </div>
                </div>
